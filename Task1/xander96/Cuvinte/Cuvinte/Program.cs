...
namespace Cuvinte
{
        ...
        public static string NumberToWords(long number)
        {
            ...
            if ((number / 1000000000) > 0)
            {
                ...
                else
                {
                    ...
                    if ((number / 1000000000) < 20)
                        {
                            words += NumberToWords(number / 1000000000) + " miliarde ";
                        }
                    else
                        {
            ...
            if (number > 0)
            {
                ...
                var unitsMap = new[] { "unu", "doua", "trei", "patru", "cinci", "sase", "sapte", "opt", "noua", "zece", "unspezece", "douasprezece", "treisprezece", "paisprezece", "cincisprezece", "saisprezece", "saptesprezece", "optsprezece", "nouasprezece" };
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            res = s.GetLast(12);
            if (string.Compare(res, "douasprezece") == 0)
            {
                s = s.Substring(0, s.Length - 12) + "doisprezece";
            }
